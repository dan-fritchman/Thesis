...
\def\markdownRendererUlBeginTight{%
  % NOTE: 
  % This is Dan's one "contrubtion" and/or modification - 
  % sticking some whitespace before & after bullet lists. 
  % It's definitely the most likely thing in here to go wrong!
  \vspace{2.5mm}
